      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-20 py-12 bg-background">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="flex flex-col gap-3 mb-6">
            ...
            {/* Spotify sign-in removed: dev mode caps at 5 users and Extended Quota
                Mode requires 250k+ MAU (policy since May 2025). Provider config
                remains in Supabase — restore this button if that ever changes. */}
          </div>

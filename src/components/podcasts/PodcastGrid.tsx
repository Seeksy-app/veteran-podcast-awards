...
import { Mic, Search, Trophy, Users, TrendingUp, Loader2, Plus } from "lucide-react";
import { Input } from "@/components/ui/input";
import { Button } from "@/components/ui/button";
import { Link } from "react-router-dom";

function SectionHeading({ icon: Icon, title, subtitle, count }: {
...
export const PodcastGrid = () => {
  ...
  return (
    <>
      ...
      {/* Tier 1: Register — placeholder cards to encourage registration */}
      {!activeSearch && <RegisterPlaceholderCards />}

      {/* Tier 2: Nominated — community-submitted, not yet registered */}
      ...
      {/* Tier 3: All Military & Veteran Podcasts — the existing directory */}
      {filteredPodcasts.length > 0 && (
        <section className="mb-16">
          <SectionHeading
            icon={Mic}
            title="All Military & Veteran Podcasts"
            subtitle="Browse the full directory of veteran and military podcasts"
      ...
      {/* Tier 4: Top Military & Veteran Podcasts from Podchaser */}
      {!activeSearch && (
        <section className="mb-16">
          <SectionHeading
            icon={TrendingUp}
